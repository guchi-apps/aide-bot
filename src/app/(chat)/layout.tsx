 ...
 * 左メニューに出す今月の一言（#133）。
 *
 * **従量課金ぶんの費用があるうちは金額、無くなったら定額ぶんの回数を出す。** #183で朝の見通しも
 * Codexへ移り、**新しく積まれる記録はすべて定額ぶん**になった（従量課金ぶんは移行前の記録が
 * 今月から外れれば0になる）。金額だけを出し続けると、実際には毎日使っているのに
 * 「今月 $0.00」が並び、使っていないように読める。**費用が出ている間は金額を優先する**
 * ——出ている額を隠す方が分かりにくい。
 */
